...
namespace PackterViewer
{
    class PackterDisplayControl : GraphicsDeviceControl
    {
        ...
        PackterViewer.PacketReader packetReader_v4 = null;
        PackterViewer.PacketReader packetReader_v6 = null;
        ...
        // from http://gamedev.stackexchange.com/questions/2438/how-do-i-create-bounding-boxes-with-xna-4-0http://gamedev.stackexchange.com/questions/2438/how-do-i-create-bounding-boxes-with-xna-4-0http://gamedev.stackexchange.com/questions/2438/how-do-i-create-bounding-boxes-with-xna-4-0http://gamedev.stackexchange.com/questions/2438/how-do-i-create-bounding-boxes-with-xna-4-0
        ...
        {
#if true
            return UpdateBoundingBox(model, new Matrix());
#else
        ...
        public void LoadContent()
        {
            ...
            try
            {
                packetReader_v6 = new PackterViewer.PacketReader(new IPEndPoint(IPAddress.IPv6Any, ConfigReader.Instance.BindPort));
            ...
            try
            {
                packetReader_v4 = new PackterViewer.PacketReader(new IPEndPoint(IPAddress.Any, ConfigReader.Instance.BindPort));
